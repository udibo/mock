...
[![deno doc](https://img.shields.io/badge/deno-doc-success?logo=deno)](https://doc.deno.land/https/deno.land/x/mock@v0.6.1/mod.ts)
...
import { spy, Spy } from "https://deno.land/x/mock@v0.6.1/mod.ts";
// Import from GitHub
...
See [deno docs](https://doc.deno.land/https/deno.land/x/mock@v0.6.1/mod.ts) for more information.
...
```ts
import { assertEquals } from "https://deno.land/std@0.69.0/testing/asserts.ts";
import { stub, Stub } from "https://deno.land/x/mock@v0.6.1/stub.ts";
...
import { assertEquals } from "https://deno.land/std@0.69.0/testing/asserts.ts";
import { spy, Spy } from "https://deno.land/x/mock@v0.6.1/spy.ts";
import { FakeTime } from "https://deno.land/x/mock@v0.6.1/time.ts";
