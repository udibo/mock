...
[![version](https://img.shields.io/badge/release-v0.9.4-success)](https://github.com/udibo/mock/tree/v0.9.4)
[![deno doc](https://img.shields.io/badge/deno-doc-success?logo=deno)](https://doc.deno.land/https/deno.land/x/mock@v0.9.4/mod.ts)
...
// Import from GitHub
import { spy, Spy } "https://raw.githubusercontent.com/udibo/mock/v0.9.4/mod.ts";
```
...
// Import from GitHub
import { spy, Spy } from "https://raw.githubusercontent.com/udibo/mock/v0.9.4/spy.ts";
```
...
```js
import { spy, Spy } from "./mock_v0.9.4.js";
```
...
```js
import { spy, Spy } from "./mock_v0.9.4.mjs";
```
...
See [deno docs](https://doc.deno.land/https/deno.land/x/mock@v0.9.4/mod.ts) for more information.
