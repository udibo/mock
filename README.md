...
import { spy, Spy } from "https://deno.land/x/mock@v0.8.0/mod.ts";
// Import from GitHub
import { spy, Spy } "https://raw.githubusercontent.com/udibo/mock/v0.8.0/mod.ts";
```
...
```ts
// Import from Deno's third party module registry
import { spy, Spy } from "https://deno.land/x/mock@v0.8.0/spy.ts";
// Import from GitHub
import { spy, Spy } from "https://raw.githubusercontent.com/udibo/mock/v0.8.0/spy.ts";
```
...
```js
import { spy, Spy } from "./mock_v0.8.0.js";
```
...
```js
import { spy, Spy } from "./mock_v0.8.0.mjs";
```
...
See [deno docs](https://doc.deno.land/https/deno.land/x/mock@v0.8.0/mod.ts) for more information.
...
```ts
import { assertEquals } from "https://deno.land/std@0.74.0/testing/asserts.ts";
import { stub, Stub } from "https://deno.land/x/mock@v0.8.0/stub.ts";
...
import { assertEquals } from "https://deno.land/std@0.74.0/testing/asserts.ts";
import { spy, Spy } from "https://deno.land/x/mock@v0.8.0/spy.ts";
import { FakeTime } from "https://deno.land/x/mock@v0.8.0/time.ts";
