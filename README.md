...
[![version](https://img.shields.io/badge/release-v0.7.0-success)](https://github.com/udibo/mock/tree/v0.7.0)
[![deno doc](https://img.shields.io/badge/deno-doc-success?logo=deno)](https://doc.deno.land/https/deno.land/x/mock@v0.7.0/mod.ts)
...
import { spy, Spy } from "https://deno.land/x/mock@v0.7.0/mod.ts";
// Import from GitHub
import { spy, Spy } "https://raw.githubusercontent.com/udibo/mock/v0.7.0/mod.ts";
```
...
```ts
// Import from Deno's third party module registry
import { spy, Spy } from "https://deno.land/x/mock@v0.7.0/spy.ts";
// Import from GitHub
import { spy, Spy } from "https://raw.githubusercontent.com/udibo/mock/v0.7.0/spy.ts";
```

#### Sub-modules

`spy.ts` module is for spying on functions and instance methods without changing behavior.

`stub.ts` module is for spying on instance methods and faking how they respond to calls.

`time.ts` module is for controlling the Date object and timers.

`callbacks.ts` module contains a set of functions you may want to use when stubbing instance methods.
...
```js
import { spy, Spy } from "./mock_v0.7.0.js";
```
...
```js
import { spy, Spy } from "./mock_v0.7.0.mjs";
```
...
See [deno docs](https://doc.deno.land/https/deno.land/x/mock@v0.7.0/mod.ts) for more information.

### Spy

When spying on a function or instance method, all arguments and return values are recorded but the behavior of that function is unchanged. This gives you the ability to verify that the code you are testing calls functions it depends on correctly and that they return the responses you expect them to.
...
```ts
import { assertEquals } from "https://deno.land/std@0.71.0/testing/asserts.ts";
import { stub, Stub } from "https://deno.land/x/mock@v0.7.0/stub.ts";
...
import { assertEquals } from "https://deno.land/std@0.71.0/testing/asserts.ts";
import { spy, Spy } from "https://deno.land/x/mock@v0.7.0/spy.ts";
import { FakeTime } from "https://deno.land/x/mock@v0.7.0/time.ts";
